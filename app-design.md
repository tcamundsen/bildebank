...
- historiske migreringer ligger i devel-docs/database-v4-migration.md og
  ...
  devel-docs/database-v11-migration.md og
  devel-docs/database-v12-migration.md
- ny runtime-kode skal anta v12, med mindre oppgaven eksplisitt gjelder
  migrering
