...
- historiske migreringer ligger i devel-docs/database-v4-migration.md og
  ...
  devel-docs/database-v7-migration.md, devel-docs/database-v8-migration.md og
  devel-docs/database-v9-migration.md
- ny runtime-kode skal anta v9, med mindre oppgaven eksplisitt gjelder
  migrering
