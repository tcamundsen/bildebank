...
def render_lock(profile: LockProfile, distributions: tuple[LockedDistribution, ...]) -> str:
    lines = [
        f"# Candidate dependency lock for Bildebank {profile.name}.",
        "# Generated by tools/update_dependency_locks.py.",
        "# Target platform: Windows x64, CPython 3.13.",
        "# Do not edit manually. Test before committing.",
        "--only-binary=:all:",
        "--require-hashes",
        "",
    ]
