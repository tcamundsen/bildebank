...
class StaticBrowserCliTests(unittest.TestCase):
    ...
    def test_server_month_thumbnails_clip_rotated_images(self) -> None:
        ...
        self.assertIn(".years-grid-server {\n      grid-template-columns: repeat(6, minmax(120px, 1fr));", SERVER_CSS)
        self.assertIn(".years-grid-server .text", SERVER_CSS)
        self.assertIn("padding: 6px 8px;", SERVER_CSS)
        self.assertIn(".years-grid-server .score { margin-top: 2px; }", SERVER_CSS)
        self.assertIn(".years-grid-server .path,\n    .years-grid-server .score", SERVER_CSS)
        ...
        self.assertIn(".years-grid-server { grid-template-columns: repeat(auto-fill, minmax(160px, 1fr)); }", SERVER_CSS)
