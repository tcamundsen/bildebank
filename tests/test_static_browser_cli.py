...
class StaticBrowserCliTests(unittest.TestCase):
    ...
    def test_server_month_thumbnails_clip_rotated_images(self) -> None:
        ...
        self.assertIn(".years-grid-server .item", SERVER_CSS)
        self.assertIn("flex-direction: column;", SERVER_CSS)
        self.assertIn("aspect-ratio: 16 / 9;", SERVER_CSS)
        self.assertIn("background: var(--panel);", SERVER_CSS)
