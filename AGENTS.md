...
- Ingen kommando skal permanent slette bildefiler. Unntakene er kommandoen
  unimport og den eksplisitt bekreftede purge-flyten med
  `pending_file_purges` og tombstone. Hvis vi kjører unimport av en import,
  skal resultatet på bildesamlingens databaser og bilder være som om importen
  vi har kjørt unimport på aldra har skjedd.
